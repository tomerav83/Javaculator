...
public class LiteralCollector extends PatternCollector<String> {
    public static final LiteralCollector INSTANCE = new LiteralCollector(Patterns.NUMBERS);

    private LiteralCollector(Pattern pattern) {
        super(pattern);
    }
